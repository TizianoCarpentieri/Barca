...
| Voce | Regola |
|------|--------|
| Quote proprietà / acquisto | **1/N** (oggi N=3 → 1/3) |
| Costi fissi di possesso | **1/N** (RC, tagliando programmato, usura normale) |
| Costi variabili di uscita | Chi partecipa, in parti uguali (benzina, ticket…) |
| Modo d’uso atteso | Uscite **di gruppo** come normale; solitarie = eccezione ancora da chiudere |
| Pagamenti | **Niente cassa contanti**: un socio anticipa con scontrino → gli altri rimborsano |
| Cap 30 €/testa/mese | **Non hard** sul gommone auto (nato da scenario porto/rimessaggio). Vedi [[preferenze/budget]] |
...
- Si può uscire; la quota economica si **liquida** (non resta un “terzo fantasma”).
- Il **tempo** di possesso pesa più del conteggio uscite (le uscite sono un correttivo secondario).
- I rimanenti rinormalizzano le quote a **1/(N−1)** dopo il regolamento.
- Parametri numerici e formula: solo nella bozza patto, da chiudere insieme.
...
- [ ] Revisione collettiva e firma del patto
- [ ] Uscite solitarie: sì/no definitivo
- [ ] Intestatario gommone / motore / polizza
- [ ] Custode e luogo (criterio pratico carico/scarico)
- [ ] 4° socio: solo se serve; non obbligatorio per il piano A
