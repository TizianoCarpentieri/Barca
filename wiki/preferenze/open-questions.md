...
Solo decisioni ancora necessarie. Chiuse → [[log]] e pagine tematiche.
...
- [ ] Popolare [[sintesi/shortlist]] con ≥3 bundle verificabili ≤2.000 €.
- [ ] Checklist ispezione tubolari / paiolato / specchio poppa / motore.
- [ ] Riserva post-acquisto nel budget.
- [ ] Omologazione: 4 pax bastano o 5–6 è vincolo reale?

## Gestione operativa

- [ ] Uscite **solitarie**: sì/no definitivo (modo normale = gruppo).
- [ ] Canale ufficiale di gruppo + cartella documenti condivisa (Drive o eq.).
...
- [ ] Fonti ufficiali limiti senza patente (periodico).
- [ ] Ricerche web utili da Sbarco → wiki prima che restino solo in KV.
