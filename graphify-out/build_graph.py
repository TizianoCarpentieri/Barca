...
add_node("Track D - Vele", "concept", "wiki/preferenze/track-vele.md")
...
add_edge("Dual Track", "Track D - Vele", "contains")
...
add_node("Budget vela ≤9000€ in due", "constraint", "wiki/preferenze/budget.md")
add_node("Fissi vela ≤700€/testa/anno all-in", "constraint", "wiki/preferenze/track-vele.md")
add_node("Stretch vela 10000€ e 900€/testa", "constraint", "wiki/preferenze/budget.md")
...
add_edge("Budget vela ≤9000€ in due", "Track D - Vele", "constrains")
add_edge("Fissi vela ≤700€/testa/anno all-in", "Track D - Vele", "constrains")
add_edge("Stretch vela 10000€ e 900€/testa", "Budget vela ≤9000€ in due", "qualifies")
...
# ── Comet 770 / sogno vela ────────────────────────────────────────
add_node("Comet 770", "model", "wiki/modelli/comet-770.md")
add_node("Comar Yachts", "brand", "wiki/modelli/comet-770.md")
add_node("Jean-Marie Finot", "person", "wiki/modelli/comet-770.md")
add_node("Cabinato 7-9 m", "type", "wiki/preferenze/track-vele.md")
add_node("Deriva imbullonata senza madieri", "spec", "wiki/modelli/comet-770.md")
add_node("Pescaggio 1.45-1.50 m", "spec", "wiki/modelli/comet-770.md")
add_node("Farymann diesel originale", "spec", "wiki/modelli/comet-770.md")
add_node("Osmosi e coperta balsa", "risk", "wiki/modelli/comet-770.md")
add_node("Anzio slot 8.50 banchina 4282€ IVA", "estimate", "wiki/concetti/costi-possesso-cabinato.md")
add_node("Anzio boa 8.50 3239€ IVA", "estimate", "wiki/concetti/costi-possesso-cabinato.md")
add_node("Fiumicino foce da preventivare", "open_question", "wiki/preferenze/open-questions.md")
add_node("Patente oltre 6 miglia anche a vela", "regulation", "wiki/normativa/limiti-senza-patente.md")
add_node("Ponza richiede patente senza limiti", "regulation", "wiki/normativa/limiti-senza-patente.md")
add_node("Conversazioni audio 2026-08-20", "source", "wiki/sintesi/conversazioni-audio-20260820.md")
add_node("Soci extra vela benvenuti", "preference", "wiki/preferenze/gruppo.md")

add_edge("Comet 770", "Comar Yachts", "built_by")
add_edge("Comet 770", "Jean-Marie Finot", "designed_by")
add_edge("Comet 770", "Cabinato 7-9 m", "is_type")
add_edge("Comet 770", "Deriva imbullonata senza madieri", "has_spec")
add_edge("Comet 770", "Pescaggio 1.45-1.50 m", "has_spec")
add_edge("Comet 770", "Farymann diesel originale", "has_spec")
add_edge("Comet 770", "Osmosi e coperta balsa", "has_risk")
add_edge("Comet 770", "Track D - Vele", "belongs_to")
add_edge("Track D - Vele", "Cabinato 7-9 m", "includes")
add_edge("Track D - Vele", "Anzio slot 8.50 banchina 4282€ IVA", "constrained_by")
add_edge("Anzio slot 8.50 banchina 4282€ IVA", "Fissi vela ≤700€/testa/anno all-in", "exceeds")
add_edge("Anzio boa 8.50 3239€ IVA", "Fissi vela ≤700€/testa/anno all-in", "stresses")
add_edge("Fiumicino foce da preventivare", "Track D - Vele", "blocks")
add_edge("Patente oltre 6 miglia anche a vela", "No patente nautica", "extends")
add_edge("Ponza richiede patente senza limiti", "Patente oltre 6 miglia anche a vela", "implies")
add_edge("Conversazioni audio 2026-08-20", "Track D - Vele", "documents")
add_edge("Conversazioni audio 2026-08-20", "Comet 770", "documents")
add_edge("Soci extra vela benvenuti", "Track D - Vele", "enables")
add_edge("Tiziano", "Track D - Vele", "pursues")
add_edge("Antonio", "Track D - Vele", "pursues")
