...
# → {"status":"ok","version":"2.5.1","deepResearch":true,"knowledgeSource":"wiki-runtime",...}
```
...
1. `/api/health` riporta `version: 2.5.1` e la policy quota attiva (Base 1 credito, Pro 2).
